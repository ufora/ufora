...
class PythonIoTaskRequestWrapper :
		public native::module::Exporter<PythonIoTaskRequestWrapper> {
public:
...
//this file
template<>
char native::module::Exporter<PythonIoTaskRequestWrapper>::mEnforceRegistration =
		native::module::ExportRegistrar<
			PythonIoTaskRequestWrapper>::registerWrapper();
