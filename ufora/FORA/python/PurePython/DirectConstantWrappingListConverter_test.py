...
class DirectConstantWrappingListConverter(unittest.TestCase):
    def setUp(self):
    ...
    def test_pyLists_4(self):
        ...
        self.assertEqual(v[0], foraList[0])
    ...
    def test_pyLists_7(self):
        ...
        for ix in range(-3, 3):
            self.assertEqual(v[ix], foraList[ix])
    ...
    def test_listComprehensions_2(self):
        def listComprehensions_2():
            aList = [0,1,2,3]
            return [elt for elt in aList if elt % 2 == 0][-1]

        self.checkFunctionEquivalence(listComprehensions_2)
    ...
    def test_basicLists_1(self):
        ...
        self.checkFunctionEquivalence(basicLists, range(4))
