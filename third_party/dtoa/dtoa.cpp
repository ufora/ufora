...
#define strtod ufora_strtod
#define dtoa ufora_dtoa
#define freedtoa ufora_freedtoa
...
#define ACQUIRE_DTOA_LOCK(n) boost::mutex::scoped_lock lock(n == 0 ? mutex1 : mutex2);

#define FREE_DTOA_LOCK(n) lock.unlock();
