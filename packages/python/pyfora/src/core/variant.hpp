/*
  Minimally edited from Tibor Djurica Potpara's blog:
  https://www.ojdip.net/2013/10/implementing-a-variant-type-in-cpp/  

  Original gist available at https://gist.github.com/tibordp/6909880

  Blog is released under Creative Commons Attribution 3.0 Unported License
 */
#pragma once
...
public: 
    ...
    /*
      Bug: this allows setting arbitrary types, ie not any type
      listed in the original template instantiation of this class.
     */
